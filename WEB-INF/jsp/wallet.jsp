        ...
        <div class="">
            <form method="post" action="QRDepositMoneyServlet">
                <div class="pay_input">
                    <div class="cp_iptxt">
                        <label class="ef">
                            <input type="number" name="money" max="50000" min="100" step="10" placeholder="金額を入力" required>
                        </label>
                    </div>
                    <div>
                        <input type="image" src="<c:url value='/image/wallet.png' />" class="submit_box" value="入金">
                    </div>
                </div>
            </form>
        </div>
