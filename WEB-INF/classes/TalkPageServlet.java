...
public class TalkPageServlet extends HttpServlet{
    public void doPost(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException{
        ...
        if(Fdao.getFriendAddJudge(chat_id)){
            friendJudge = "<span id='friendAdd' onclick='ajaxFriendAdd("+chat_id+")'>í«â¡</span>";
        }else if(Fdao.getFriendDeleteOrBlockJudge(chat_id)){
            friendJudge = "<span id='frienddDeleteOrBlock' onclick='ajaxFriendRelease("+chat_id+")'>âèú</span>";
        }
