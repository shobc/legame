...
@WebServlet("/shopAdmin/DateSortCancelServlet")
public class DateSortCancelServlet extends HttpServlet{
    public void doPost(HttpServletRequest req,HttpServletResponse res)throws IOException,ServletException{
        ...
        pb.setDate(date);
        ArrayList propertyList = dao.getDateSortCancel(pb);
        req.setAttribute("caption",date+" •Ô‹àƒŠƒXƒg");
